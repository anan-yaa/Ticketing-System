-- CreateEnum
CREATE TYPE "SystemRole" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'CUSTOMER', 'L1_ENGINEER', 'L2_ENGINEER', 'L3_ENGINEER', 'MANAGER');

-- CreateEnum
CREATE TYPE "TicketStatus" AS ENUM ('OPEN', 'PENDING', 'WAITING', 'CLOSED');
